...
Para aprovechar el día del espectador, Carmen decide ir al cine con sus amigos y sale de su casa con 23€. Al regresar se 
da cuenta que le quedan 12.75€ ¿Sabrías programar cuánto se ha gastado? */

public class Ejercicio04 {
    public static void main(String[] args) {

        double dineroTotal = 23, dineroRestante = 12.75;

        System.out.println("Carmen se gasto: $"+(dineroTotal-dineroRestante));
